...
DATA.buildings = {
  ...
  arrow_tower:   { key: 'arrow_tower', name: 'Arrow Tower', cost: 200, hp: 900, w: 2, d: 2, cat: 'tower', tower: true,
                   range: 20, dmg: 18, cd: 1.1, projectile: 'arrow', desc: 'Fast-firing tower. Good all-rounder.' },
  ballista_tower:{ key: 'ballista_tower', name: 'Ballista Tower', cost: 360, hp: 1000, w: 2, d: 2, cat: 'tower', tower: true,
                   range: 28, dmg: 86, cd: 2.8, projectile: 'ballista', bonusVsLarge: 1.7, desc: 'Slow, huge single hits. +70% damage to large enemies.' },
  mage_tower:    { key: 'mage_tower', name: 'Mage Tower', cost: 480, hp: 800, w: 2, d: 2, cat: 'tower', tower: true,
                   range: 22, dmg: 45, cd: 2.2, projectile: 'magic', desc: 'Lobs exploding fire that splashes in 3.5m and burns.' },
  frost_tower:   { key: 'frost_tower', name: 'Frost Tower', cost: 390, hp: 800, w: 2, d: 2, cat: 'tower', tower: true,
                   range: 18, dmg: 14, cd: 0.9, projectile: 'frost', desc: 'Weak damage but slows targets by 50%.' },
  cannon_tower:  { key: 'cannon_tower', name: 'Cannon Tower', cost: 580, hp: 1100, w: 2, d: 2, cat: 'tower', tower: true,
  ...
  lightning_tower:{ key: 'lightning_tower', name: 'Lightning Tower', cost: 510, hp: 850, w: 2, d: 2, cat: 'tower', tower: true,
                   range: 18, dmg: 28, cd: 1.7, chain: { count: 4, radius: 6 }, desc: 'Chain lightning that arcs to four enemies and ignores armour.' },
  poison_tower:  { key: 'poison_tower', name: 'Poison Tower', cost: 360, hp: 800, w: 2, d: 2, cat: 'tower', tower: true,
                   range: 18, dmg: 8, cd: 1.1, projectile: 'poison', desc: 'Darts that poison for 12 damage/s over 4s. Stacks nothing, but never misses.' },
  watchtower:    { key: 'watchtower', name: 'Watchtower', cost: 480, hp: 900, w: 2, d: 2, cat: 'tower', tower: true,
